...
public class PlacementProblem {
	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting Simon's Application...");
		...
		try {
			...
			createMobileUsers(broker.getId(), application, datasetReference);
...
//			clusterLevelIdentifier.add(2);
			...
			int placementAlgo = PlacementLogicFactory.MY_MICROSERVICES_PLACEMENT;
	...
	private static void createMobileUsers(int userId, Application app, String datasetReference) throws IOException {
