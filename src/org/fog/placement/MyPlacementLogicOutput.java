...
public class MyPlacementLogicOutput extends PlacementLogicOutput{
    ...
    public MyPlacementLogicOutput(Map<Integer, Map<Application, List<ModuleLaunchConfig>>> perDevice, Map<Integer, List<Pair<String, Integer>>> serviceDiscoveryInfo, Map<PlacementRequest,Integer> prStatus, Map<Integer, PlacementRequest> targets) {
        super(perDevice, serviceDiscoveryInfo, prStatus);
        this.targets = targets;
    }

    public Map<Integer, PlacementRequest> getTargets() {
        return targets;
    }
}
